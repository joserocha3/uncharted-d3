/*-------------------------------------------------------------------------*
 * Object name:   IndicatorPillarForm.jsx
 * Created by:    Pablo Rocha
 * Creation date: ???
 * Description:   Component to render pillar form
 *-------------------------------------------------------------------------
...
@inject('indicators') @observer
export default class IndicatorPillarForm extends React.Component {
